...
export default function HomePage() {
  ...
  return (
    <div className="overflow-x-clip">
      <section className="relative flex min-h-[80vh] items-center overflow-hidden px-4 py-10">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              {[
                ...
                <Reveal
                  ...
                  delay={i * 90}
                  className="border border-charcoal/15 bg-sage/20 px-5 py-6 text-center"
                >
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              {testimonials.slice(0, 2).map((t, i) => (
                <Reveal key={t.id} variant={i === 0 ? "left" : "right"} delay={i * 100}>
