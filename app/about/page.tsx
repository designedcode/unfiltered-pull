...
export const metadata: Metadata = {
  title: "About",
  description:
    "Unfiltered Pull is raw tarot, moon rituals, and spiritual guidance: no fluff, no gatekeeping. First Pull is complimentary for first-time clients.",
};
    ...
    <div className="mx-auto max-w-3xl px-4 pb-10 pt-8">
      ...
      <div className="mt-6 grid gap-3">
        {[
          ...
          <Reveal key={t} variant={i % 2 === 0 ? "left" : "right"} delay={i * 70}>
            <div className="border border-charcoal/15 bg-sage/20 px-5 py-5">
      ...
      <Reveal variant="scale">
        <Image
          src="/brand/about-pillars.jpg"
          alt="Raw Real Revealed"
          width={900}
          height={1200}
          className="mt-8 h-auto w-full rounded-3xl object-cover"
        />
      </Reveal>
      <Reveal variant="blur">
